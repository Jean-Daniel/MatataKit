...
class MatataCoreTests: XCTestCase {
  ...
  func testHandshake() throws {
    // Not in sensor mode
    XCTAssertEqual(Handshake.packet, Data([0xfe, 0x4, 0x88, 0x7, 0xf2, 0x8a]))
  ...
  func testCRC() throws {
    XCTAssertEqual(Data([0xfe, 0x06, 0x7e, 0x2, 0x0, 0x0, 0x52, 0xc6]),
                   try IO.encode(IO.decode([0xfe, 0x06, 0x7e, 0x2, 0x0, 0x0, 0x52, 0xc6]), withLength: false))

    XCTAssertEqual(Data([0xfe, 0x07, 0x7e, 0x2, 0x2, 0x0, 0x0, 0x97, 0x77]),
                   try IO.encode(IO.decode([0xfe, 0x07, 0x7e, 0x2, 0x2, 0x0, 0x0, 0x97, 0x77]), withLength: false))
  }
